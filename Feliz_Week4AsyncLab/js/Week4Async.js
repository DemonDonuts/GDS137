...
var hitBox = false
var img = document.getElementById("scallywag.png");


function hitTheBox(){
	//Renders Text when you hit the box, changes color, and spawns img
	if(!hitBox){
		message = "You hit the box!"
		console.log(message)
		setTimeout(clearMessage,3000)
		hitBox = true
		//change color of box when hit
		platform3.color = "#00ff00";

		// Source - https://stackoverflow.com/a/52901237
	// Posted by hossein sedighian
